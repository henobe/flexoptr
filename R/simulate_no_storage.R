...
#'
#' @param parameters a named vector, which must contain \code{loss_rate} and \code{starting_state}.
#' @param prices a numeric vector.
#'
#' @return a list of schedule, state, ans trades. Compatible with \code{optimise_schedule}
#' @export
