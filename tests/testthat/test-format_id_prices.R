some_prices <- data.frame(time = c(1, 2, 3, 4, 5),
...
test_that("Order of arguments controls order of elements", {
  expect_equal(format_id_prices(some_prices, c("id_1", "id_2", "id_3"))$lookout[[1]],
               c(NA, 30, 39, 49))
  expect_equal(format_id_prices(some_prices, c("id_1", "id_3", "id_2"))$lookout[[1]],
               c(NA, 30, 41, 48))
  expect_equal(format_id_prices(some_prices, c("id_3", "id_2", "id_1"))$lookout[[1]],
               c(NA, 27, 39, 50))
})
